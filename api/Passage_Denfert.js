// Fichier : /api/Passage_Denfert.js

export default async function handler(request, response) {
  // Constantes pour Denfert-Rochereau -> Sud
  const arretId = "STIF:StopArea:SP:71056:";
  const destinationsFiltre = [
    "Robinson", "Saint-Rémy-lès-Chevreuse", "Massy - Palaiseau",
    "Orsay Ville", "Palaiseau", "La Croix de Berny"
  ];
  ...
  try {
    ...
    console.error("Erreur dans l'API Passage_Denfert:", error);
